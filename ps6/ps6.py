...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for m in lower:
            ...
            map_dict[m]=chr(value)
        for u in string.ascii_uppercase:
            vlaue2=ord(u)
            value2=value2+shift
            if value2<65:
                value2=90-(65-value2)+1
            elif value2>90:
                value2=65+(value2-90)-1
            map_dict[u]=chr(value2)
        return map_dict
    ...
    def apply_shift(self, shift):
        ...
        '''
        map_dic=self.build_shift_dict(shift) 
        ss=''
        for l in self.message_text:
            if  not l in map_dict
                ss+=l
            else:
                ss+=map_dic[l]
        return ss
    ...
    def decrypt_message(self):
        ...
        for i in range(26):
            ...
            if word_num>max_words:
                max_words=word_num
                actualkey=i
        decrypted="".join(self.apply_shift(actualkey))
        return (actualkey,decrypted)
